...
# 1. Prepare the txt file containing the image names that you want to process
# 2. Run
...
if __name__ == '__main__':
    ...
    # This is an example, you should change it with your own txt file
    basename = 'C:\\Users\\ZHAO Yuzhi\\Desktop\\dataset\\ILSVRC2012_train_256\\'
    imagename = text_readlines('ILSVRC2012_train_name.txt')         # 1281167 images in all for ImageNet training dataset
    #imagename = text_readlines('COCO2014_val_name.txt')             # 40514 images in all for COCO validation dataset

    result_dir = 'C:\\Users\\ZHAO Yuzhi\\Desktop\\dataset\\ILSVRC2012_train_256_saliencymap\\'
    
    count = 0
    for image_path in imagename:
        ...
        cv2.imwrite(os.path.join(result_dir, image_name), saliency_map)
