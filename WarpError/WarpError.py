...
if __name__ == "__main__":
    ...
    for i in range(len(imglist)):
        ...
        for j in range(imglist[i] - 1):
            ...
            scaled_l1loss = F.l1_loss(second_tensor, second_warpped) * (second_tensor.shape[2] * second_tensor.shape[3]) / count
            # counting
            loss = loss + scaled_l1loss
